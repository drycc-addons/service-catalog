...
$( document ).ready(function() {
    if(forwarding) {
        ...
        $("#continueEditButton").attr("href", "https://github.com/drycc-addons/service-catalog/edit/master{{ page.docsbranch }}/" + forwarding)
        $("#viewOnGithubButton").text("View " + forwarding + " on GitHub");
        $("#viewOnGithubButton").attr("href", "https://github.com/drycc-addons/service-catalog/blob/master{{ page.docsbranch }}/" + forwarding)
    } else {
...
<p><a class="button" href="https://github.com/drycc-addons/service-catalog/tree/master/docs">Browse this site's source code</a></p>
