...
// This feature was copied from Service Catalog admission plugin https://github.com/drycc-addons/service-catalog/blob/v0.1.41/plugin/pkg/admission/broker/authsarcheck/admission.go
