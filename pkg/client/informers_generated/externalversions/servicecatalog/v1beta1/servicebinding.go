...
type ServiceBindingInformer interface {
	...
	Lister() servicecatalogv1beta1.ServiceBindingLister
}
...
func NewFilteredServiceBindingInformer(client clientset.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&apisservicecatalogv1beta1.ServiceBinding{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisservicecatalogv1beta1.ServiceBinding{}, f.defaultInformer)
}

func (f *serviceBindingInformer) Lister() servicecatalogv1beta1.ServiceBindingLister {
	return servicecatalogv1beta1.NewServiceBindingLister(f.Informer().GetIndexer())
}
